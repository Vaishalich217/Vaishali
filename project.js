...
let Firstname=['Victoria','Stella','Ryan'];
console.log(Firstname);
console.log(Firstname.length);
console.log(Firstname[0]);
console.log(Firstname.indexOf('Stella'));
console.log(Firstname.includes('Stella'));
console.log(Firstname.push("Victoria"));
console.log(Firstname.pop());
console.log(Firstname.shift());
console.log(Firstname.unshift('Victoria'));
console.log(Firstname.slice(0,1));
console.log(Firstname.reverse());
console.log(Firstname.splice(0,2));
console.log(Firstname.concat(['Victoria','Victoria']));
